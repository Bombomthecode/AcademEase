...
class AcademEase(MDApp):
    ...
    def task_content(
        ...
        if self.source == "user":
            ...
            toast("Your Task Is Saved Successfully")
    ...
    def notes_content(
        ...
        if self.cond == "pass":
            ...
            toast("Your Notes Is Saved Successfully")
    ...
    def remove_pass(self):  # check if password already set or not
        ...
        if self.checkpassfile == "":
            ...
            toast("There is no password set! Please Enter a password")
        else:
    ...
    def remove_file_pass(self):  # remove password from file
        ...
        if Oldpass == self.root.ids.rmv_pass.text:
            ...
            checkoldpass.close()
            toast("Your Password removed successfully")
            self.root.ids.screen_manager.current = "settings"
        else:
    ...
    def delete_finished(self):  # dialog to delete finished tasks list
        self.finished_dialog = MDDialog(
            title="Do you want to Delete all on completed tasks?",
            text="This will delete all the completed tasks in the list permanently",
            buttons=[
                MDFlatButton(
    ...
    def deletefinished(self):  # deletion of finished tasks list
        ...
        finish.write("YOU COMPLETED YOUR TASKS:")
